    ...
    <Layout title="{kehrnel}" description="Multi-strategy healthcare data runtime">
      <main className="kehrnel-home">
        <section className="kehrnel-hero">
          <img src="/guide/img/logo.svg" alt="{kehrnel} Logo" className="kehrnel-hero-logo" />
          <h1>{'{kehrnel}'}</h1>
          ...
          <div className="kehrnel-hero-actions">
            ...
            <Link className="button button--secondary button--lg" to="/docs/api/endpoint-catalog">
              API Catalog
            </Link>
            <a className="button button--secondary button--lg" href="/openapi.json">
              OpenAPI JSON
            </a>
            <a className="button button--secondary button--lg" href="/docs/">
              Swagger UI
            </a>
            <a className="button button--secondary button--lg" href="/redoc">
              ReDoc
            </a>
          </div>
        </section>
