...
# FHIR RPS Canonical Configuration

Use `src/kehrnel/engine/strategies/fhir/rps_canonical/specification/defaults.json` as the authoritative activation baseline for `fhir.rps_canonical`.
...
Packaged example: `src/kehrnel/engine/strategies/fhir/rps_canonical/specification/activate_dev.json`.
