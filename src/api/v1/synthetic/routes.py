# src/api/v1/synthetic/routes.py
...
from src.api.v1.synthetic.service import generate_synthetic_data
from src.api.v1.synthetic.models import (
    SyntheticDataRequest,
    SyntheticDataResponse,
    SyntheticDataRecord,
    SyntheticDataStats
)
from src.api.v1.synthetic.api_responses import (
