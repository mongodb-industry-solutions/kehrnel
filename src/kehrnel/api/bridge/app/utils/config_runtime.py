...
async def apply_ingestion_config(
    ...
    # Initialize unflattener (used by composition "unflatten" endpoint)
    app.state.unflattener = CompositionUnflattener.from_flattener(app.state.flattener)
    ...
    app.state.mappings_path = flattener_mappings_path
    app.state.ingest_options = ingest_options or {}
    app.state.strategy_raw = strategy_raw or {}

    return {"mappings_path": flattener_mappings_path}
