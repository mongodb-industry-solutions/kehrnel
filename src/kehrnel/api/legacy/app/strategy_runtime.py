...
from kehrnel.strategy_runtime import StrategyRegistry, CapabilityRouter
from kehrnel.strategy_sdk import StrategyBindings, StrategyContext
from kehrnel.adapters.mongo_storage import MongoStorageAdapter
from kehrnel.api.legacy.app.core.config import settings
from kehrnel.strategy_runtime.bindings import build_bindings

from kehrnel.strategies.openehr.rps_dual.strategy import MANIFEST as OPENEHR_MANIFEST
from kehrnel.strategies.fhir.resource_first.strategy import MANIFEST as FHIR_MANIFEST
from kehrnel.strategies.fhir.fhir_contextobjects_vitals_window.strategy import MANIFEST as FHIR_SIM_MANIFEST
