...
from kehrnel.api.legacy.v1.directory.models import Folder, FolderCreate
from kehrnel.api.legacy.v1.directory.repository import (
...
from kehrnel.api.legacy.v1.common.models import ObjectRef, HierObjectID, ObjectVersionID
