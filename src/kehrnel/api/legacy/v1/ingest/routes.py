# src/kehrnel/api/legacy/v1/ingest/routes.py
...
from kehrnel.api.legacy.v1.ingest.service import IngestionService
from kehrnel.api.legacy.v1.ingest.repository import IngestionRepository
...
from kehrnel.api.legacy.v1.ingest.models import (
    FilePathRequest,
    EhrIdRequest,
    CanonicalCompositionPayload,
    IngestionSuccessResponse
)
from kehrnel.api.legacy.v1.ingest.api_responses import (
    ...
    try:
        ...
        if not preview_mode and service is None:
            raise HTTPException(
                ...
                detail="Ingestion service not configured. Use /v1/config to set up ingestion configuration."
            )
