...
from kehrnel.api.legacy.v1.composition.repository import (
...
from kehrnel.api.legacy.v1.ehr.service import retrieve_ehr_by_id
from kehrnel.api.legacy.v1.ehr.repository import find_ehr_by_id

from kehrnel.api.legacy.v1.contribution.repository import (
