"""
FHIR RPS Canonical strategy pack.
...
from kehrnel.engine.strategies.fhir.rps_canonical.scripts import denormalize
from kehrnel.engine.strategies.fhir.rps_canonical.scripts import generation
from kehrnel.engine.strategies.fhir.rps_canonical.scripts import indexes
from kehrnel.engine.strategies.fhir.rps_canonical.scripts import query as fhir_query
from kehrnel.engine.strategies.fhir.rps_canonical.scripts import stats as fhir_stats_mod
...
class FHIRRPSCanonicalStrategy(StrategyPlugin):
    ...
    async def plan(self, ctx: StrategyContext) -> ApplyPlan:
        raise NotImplementedError("fhir.rps_canonical plan not implemented")

    async def apply(self, ctx: StrategyContext, plan: ApplyPlan) -> ApplyResult:
        raise NotImplementedError("fhir.rps_canonical apply not implemented")

    async def transform(self, ctx: StrategyContext, payload: Dict[str, Any]) -> TransformResult:
        raise NotImplementedError("fhir.rps_canonical transform not implemented")

    async def reverse_transform(self, ctx: StrategyContext, payload: Dict[str, Any]) -> TransformResult:
        raise NotImplementedError("fhir.rps_canonical reverse_transform not implemented")

    async def ingest(self, ctx: StrategyContext, payload: Dict[str, Any]) -> Dict[str, Any]:
        raise NotImplementedError("fhir.rps_canonical ingest not implemented")
    ...
    async def run_op(self, ctx: StrategyContext, op: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        raise NotImplementedError(f"fhir.rps_canonical op '{op}' not implemented")
