...
from kehrnel.strategies.openehr.rps_dual_previous.ingest.flattener_f import CompositionFlattener
...
class RPSDualStrategy(StrategyPlugin):
    ...
    async def reverse_transform(self, ctx: StrategyContext, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        from kehrnel.strategies.openehr.rps_dual_previous.ingest.unflattener import CompositionUnflattener
