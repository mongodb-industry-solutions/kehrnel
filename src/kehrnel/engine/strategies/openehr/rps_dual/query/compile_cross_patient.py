"""Cross-patient compiler wrapper using the vendored transformer stack."""
...
async def compile_cross_patient(ir: AqlQueryIR, cfg: Dict[str, Any], dicts: Dict[str, Any]) -> Dict[str, Any]:
