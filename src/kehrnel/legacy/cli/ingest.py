...
from kehrnel.domains.openehr.ingest.bulk import run as ingest_bulk
from kehrnel.domains.openehr.ingest.bulk import from_mongo as ingest_from_mongo
...
def from_mongo(
    ...
    another)."""
    ingest_from_mongo(src_cfg, driver_cfg, limit)
