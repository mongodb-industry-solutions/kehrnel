...
def remap_fields_for_config(
    ...
    """
    Apply field remapping rules based on runtime_config, mirroring the logic previously in the ingest route.
    ...
    comp_cfg = fields_cfg.get("composition", {}) or runtime_config.get("composition_fields", {}) if isinstance(runtime_config, dict) else {}
    search_cfg = fields_cfg.get("search", {}) or runtime_config.get("search_fields", {}) if isinstance(runtime_config, dict) else {}
