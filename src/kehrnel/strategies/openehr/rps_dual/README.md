...
- `src/kehrnel/strategies/openehr/rps_dual/ingest/config/mongo_source.template.json`
- `src/kehrnel/strategies/openehr/rps_dual/ingest/config/mongo_driver.template.json`
