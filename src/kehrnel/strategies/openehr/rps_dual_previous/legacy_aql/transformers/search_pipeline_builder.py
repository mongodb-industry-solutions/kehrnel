...
from kehrnel.strategies.openehr.rps_dual.legacy_aql.compat.persistence import PersistenceStrategy, get_default_strategy
from kehrnel.strategies.openehr.rps_dual.legacy_aql.compat.settings import settings
import logging
import re
