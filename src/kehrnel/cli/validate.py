...
from kehrnel.engine.domains.openehr.templates import kehrnelValidator, TemplateParser
from kehrnel.engine.domains.openehr.templates.models import Severity
...
def main(
    ...
    try:
        ...
        # Accept wrapper docs produced by ingestion/export pipelines:
        # {"ehr_id": ..., "canonicalJSON": { ... COMPOSITION ... }, ...}
        if isinstance(data, dict) and isinstance(data.get("canonicalJSON"), dict):
            data = data["canonicalJSON"]
